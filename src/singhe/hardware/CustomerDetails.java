...
public class CustomerDetails extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        mainPannel2.add(phoneno, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 430, -1, -1));
        ...
        mainPannel2.add(cusPhonno, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 420, 242, 30));
        ...
        mainPannel2.add(submitbtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 500, 172, 35));
        ...
        mainPannel2.add(viewBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 560, 300, 34));
        ...
        mainPannel2.add(clearBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(520, 500, 172, 35));
        ...
        jButton1.setText("Genarate Custom Card");
        jButton1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButton1ActionPerformed(evt);
            }
        });
        mainPannel2.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(770, 510, -1, 30));
    ...
    private void submitbtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitbtnActionPerformed
        ...
        try{
            ...
            if(input == JOptionPane.YES_OPTION && a==10){
                ...
                try {
                    Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3308/singhe_hardware_db","root","Samitha@15");
                    Statement st=con.createStatement();
                    String query="insert into customers(customer_name,address,date,phone_no) values('"+name+"','"+add+"',now(),'"+tp+"');";

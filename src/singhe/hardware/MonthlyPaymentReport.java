...
public class MonthlyPaymentReport extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 680, 80, -1));

        total.setEditable(false);
        jPanel1.add(total, new org.netbeans.lib.awtextra.AbsoluteConstraints(590, 680, 170, -1));
    ...
    private void searchBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchBtnActionPerformed
        ...
        try{
            ...
            if(!month.getText().equals("")){
                String query="select * from payment where month(date)="+month.getText()+";";
                ResultSet rs =st.executeQuery(query);
                while(rs.next()){
                    p[0]=rs.getString("payment_id");
                    p[1]=rs.getString("cname");

   ...
   void showTableContent(){
    ...
    private void searchBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchBtnActionPerformed
        ...
        try{
            if(!date.getText().equals("")){
                ...
                String query="select * from customers where month(date)="+date.getText()+";";
                ResultSet rs =st.executeQuery(query);
                while(rs.next()){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MonthlyCustomerReport.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MonthlyCustomerReport().setVisible(true);
            }
        });
    }

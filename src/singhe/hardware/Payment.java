...
import static singhe.hardware.ViewPayemntDetails.row;
...
public class Payment extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnPannel.add(supBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(48, 363, 265, 72));
        ...
        btnPannel.add(inventoryBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 460, 265, 72));
        ...
        btnPannel.add(logout, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 658, 136, 36));
        ...
        mainPannel2.add(cusId, new org.netbeans.lib.awtextra.AbsoluteConstraints(712, 390, 140, 30));
        ...
        mainPannel2.add(cusIdLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 400, 150, -1));
        ...
        mainPannel2.add(amountLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 340, 180, -1));

        amount.setEditable(false);
        amount.setText("Rs : 0.00");
        amount.setPreferredSize(new java.awt.Dimension(59, 22));
        mainPannel2.add(amount, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 340, 242, 30));

        header.setFont(new java.awt.Font("Tempus Sans ITC", 0, 48)); // NOI18N
        header.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        header.setText("Add Payment");
        mainPannel2.add(header, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 120, 323, -1));
        ...
        mainPannel2.add(dateLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 460, 240, 40));
        ...
        mainPannel2.add(pname, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 180, 110, -1));

        jLabel10.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jLabel10.setText("Quantity  :");
        mainPannel2.add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 180, 110, -1));

        quantity.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        mainPannel2.add(quantity, new org.netbeans.lib.awtextra.AbsoluteConstraints(670, 180, 120, -1));
        ...
        mainPannel2.add(addBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(840, 180, -1, -1));
        ...
        mainPannel2.add(items, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 180, 120, 30));
        ...
        mainPannel2.add(cName, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 410, 120, -1));
        ...
        mainPannel2.add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 540, 70, 30));
    ...
    private void addBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addBtnActionPerformed
        ...
        try{
            ...
            try{
                ...
                int sold =Integer.valueOf(quantity.getText());
                p[0]=pname.getText();
